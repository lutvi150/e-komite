...
<link id="style_color" href="<?=base_url();?>asset/admin/layout4/css/themes/light.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="<?=base_url();?>asset/admin/pages/media/pages/earth.jpg" class="img-responsive" alt="">
</div>
